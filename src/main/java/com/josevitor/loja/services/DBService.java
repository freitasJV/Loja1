...
public class DBService {
	...
	public void instantianteTesteDatabase() throws ParseException {
		...
		Produto p3 = new Produto(null, "Mouse", 0.00);
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "vitor.itu@hotmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "jose.freitas40@etec.sp.gov.br", "79658878008", TipoCliente.PESSOAFISICA, pe.encode("123"));
